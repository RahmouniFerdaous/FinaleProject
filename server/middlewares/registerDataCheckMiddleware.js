...
body("profilePic" , "Please choose a profile picture ").not().isEmpty(),
body("age" , "Please enter your age (Numeric)").not().isEmpty().isNumeric().isLength({
    min: 2,
    max: 3,
  }),
body("phone" , "Please enter your phone (Numeric)").not().isEmpty().isNumeric().isLength({
    min: 8,
    max: 12,
  }),
];